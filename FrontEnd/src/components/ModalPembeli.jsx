...
const ModalPembeli = ({ judul, data, setData, state, onSub }) => {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className={`${
        state.modalAdd ? "flex" : "hidden"
      } overflow-y-auto bg-black/50 overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}
    >
      <div className="relative p-4 w-full max-w-md max-h-full">
        ...
        <div className="relative bg-white rounded-lg shadow-sm">
          ...
          {/* Modal body */}
          <form className="p-4 md:p-5" onSubmit={onSub}>
